            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <ul class="list-group mb-3">
                        <p class="h4 text-center"><strong>Carrito</strong> <i class="fas fa-cart-plus"></i></p>
                    ...
                    <div class="col-md-8 order-md-1">
                        <div class="conatiner bg-white rounded">
                            ...
                            <p class="text-center mt-3 mb-0 text-muted">Selecciona por lo menos un item para poder continuar.</p>
