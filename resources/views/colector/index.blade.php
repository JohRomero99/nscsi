                        ...
                        <tbody>
                            @foreach( $pensiones as $pen)
                                ...
                                <tr class="border-t odd:bg-white even:bg-gray-50 hover:bg-blue-50 transition text-center">
                                    ...
                                    <td class="px-6 py-4">{{ $pen->pension }}</td>
                                    <td class="px-6 py-4">{{ $pen->descuento }}</td>
                                    <td class="px-6 py-4">{{ $pen->total_a_pagar }}</td>
                                    <td class="px-6 py-4">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex justify-center">
                                            <!-- Modal toggle -->
                                            <button data-modal-target="modal-{{ $pen->id }}" data-modal-toggle="modal-{{ $pen->id }}" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                                                Registrar Pago <i class="fa-solid fa-coins"></i>
                                            </button>

                                            <!-- Main modal -->
                                            <div id="modal-{{ $pen->id }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                                <div class="relative p-4 w-full max-w-2xl max-h-full">
                                                    ...
                                                    <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                                        ...
                                                        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                                                            ...
                                                            <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="modal-{{ $pen->id }}">
