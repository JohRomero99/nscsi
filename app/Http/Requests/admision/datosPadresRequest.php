...
class datosPadresRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'telefono_domicilio' => ['required','regex:/^0[2-8][0-9]{7}$/'],
            ...
            'otra_ocupacion' => ['required_if:ocupacion_id,74','string'],
            ...
            'ingresos_egresos_padre.0' => ['required','numeric','min:0'],
            'ingresos_egresos_padre.1' => ['required','numeric','min:0'],
            'ingresos_egresos_padre.2' => ['required','numeric','min:0'],
            'ingresos_egresos_padre.3' => ['required','numeric','min:0'],
